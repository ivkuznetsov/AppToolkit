...
//
//  Created by Mischa Hildebrand on 12/20/2019.
//  Copyright © 2019 Ilya Kuznetsov.
//
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: CollectionViewLeftAlignedLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: CollectionViewLeftAlignedLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: CollectionViewLeftAlignedLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: CollectionViewLeftAlignedLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: CollectionViewLeftAlignedLayout) {
    ...
    func alignVertically(collectionViewLayout: CollectionViewLeftAlignedLayout) {
